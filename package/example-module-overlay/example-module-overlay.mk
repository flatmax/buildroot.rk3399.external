...
EXAMPLE_MODULE_OVERLAY_MODULE_SUBDIRS = module-overlay-rk33xx
EXAMPLE_MODULE_OVERLAY_MODULE_MAKE_OPTS = \
	INSTALL_MOD_DIR=kernel/sound/soc/rockchip \
	CONFIG_SND_SOC_MODULE_OVERLAY_RK33XX=m

define EXAMPLE_MODULE_OVERLAY_INSTALL_MOD
	mkdir -p ${BINARIES_DIR}/rockchip/overlays
	$(INSTALL) -D -m 644 $(@D)/$(EXAMPLE_MODULE_OVERLAY_MODULE_SUBDIRS)/module-overlay-rk33xx.dtbo ${BINARIES_DIR}/rockchip/overlays/
endef
